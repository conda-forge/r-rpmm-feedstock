...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rpmm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4853&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rpmm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rpmm` can be installed with:

```
conda install r-rpmm
```

It is possible to list all of the versions of `r-rpmm` available on your platform with:
